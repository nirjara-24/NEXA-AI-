# app.py – Nexa AI Chatbot Backend
...
app.secret_key = os.getenv("SECRET_KEY", "nexa-ai-secret-key-change-in-production")
...
LANGUAGE_PROMPTS = {
    "english":  "You are Nexa, a helpful and friendly AI assistant. Always respond in clear English.",
    "hindi":    "Aap Nexa hain, ek sahayak AI assistant. Hamesha Hindi mein jawab dein.",
    "hinglish": "You are Nexa, a friendly AI assistant. Respond in Hinglish (mix of Hindi and English).",
}
...
if __name__ == "__main__":
    print("=" * 55)
    print("  Nexa AI Chatbot - Backend Starting")
